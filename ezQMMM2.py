...
class QMMMGenerator:
    ...
    def extract_point_charges(self, qm_selection: str, cutoff: float,
        ...
        # Remapping ensures written coordinates are near QM and that the (0,0,0)
        # skip in _tile_images matches the primary set exactly.
    ...
    def _write_structure(self, frame: int, qm_atoms, mm_ag, base: Path,
        ...
        matching the point charge coordinates in the QM/MM input file.
